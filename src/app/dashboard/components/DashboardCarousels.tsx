...
import CourseCarouselSkeleton from '@/components/ui/CourseCarouselSkeleton';
...
const editing = [
{ id: 'ed-001', title: 'Flujo de Trabajo RAW en Lightroom', instructor: 'Alejandro Vega', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_10da27dc9-1785808845685.png", thumbnailAlt: 'Lightroom RAW workflow showing catalog organization and basic develop panel', duration: '1h 05min', tier: 'apertura' as const, lessonCount: 20, rating: 4.9 },
  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-10 pt-10">
        <CourseCarouselSkeleton count={5} />
        <CourseCarouselSkeleton count={5} />
        <CourseCarouselSkeleton count={5} />
