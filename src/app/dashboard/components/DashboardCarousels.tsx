...
const includedInMembership = [
  { id: 'im-001', title: 'Flujo de Trabajo RAW en Lightroom', instructor: 'Alejandro Vega', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_112c3cf40-1787075634923.png", thumbnailAlt: 'Lightroom RAW workflow showing catalog organization and basic develop panel', duration: '1h 05min', tier: 'apertura' as const, lessonCount: 20, rating: 4.9, accessBadge: 'Apertura+' },
  { id: 'im-002', title: 'Retoque de Piel en Photoshop CC', instructor: 'Sofía Reyes', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_1aa26c31d-1785844143724.png", thumbnailAlt: 'Professional photo retouching workflow showing skin smoothing techniques in Photoshop', duration: '22:15', tier: 'apertura' as const, lessonCount: 8, rating: 4.8, accessBadge: 'Apertura+' },
  { id: 'im-003', title: 'Fotografía de Producto en Mesa de Luz', instructor: 'Sofía Reyes', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_18c3fcab2-1772196420648.png", thumbnailAlt: 'Elegant product photography on light table with minimalist composition', duration: '18:44', tier: 'apertura' as const, lessonCount: 10, rating: 4.7, accessBadge: 'Apertura+' },
  { id: 'im-004', title: 'Iluminación Rembrandt para Retrato', instructor: 'Carlos Mendoza', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_1d731ee8d-1779952599495.png", thumbnailAlt: 'Studio lighting setup with Rembrandt pattern creating dramatic shadows on portrait subject', duration: '14:32', tier: 'obturador' as const, lessonCount: 12, rating: 4.9, accessBadge: 'Obturador+' },
  { id: 'im-005', title: 'Color Grading Cinematográfico', instructor: 'Alejandro Vega', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_1e45302fc-1783851831373.png", thumbnailAlt: 'Color grading workflow in Lightroom with cinematic teal and orange look applied', duration: '31:20', tier: 'obturador' as const, lessonCount: 16, rating: 4.9, accessBadge: 'Obturador+' },
  { id: 'im-006', title: 'Softboxes, Paraguas y Modificadores', instructor: 'Carlos Mendoza', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_129426577-1785194268625.png", thumbnailAlt: 'Array of photography light modifiers including softboxes and octaboxes on studio floor', duration: '38:00', tier: 'obturador' as const, lessonCount: 14, rating: 4.9, accessBadge: 'Obturador+' },
];

const premiumCourses = [
  { id: 'pc-001', title: 'Masterclass: Iluminación para Moda Editorial', instructor: 'Carlos Mendoza', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_1c7111102-1785194268846.png", thumbnailAlt: 'Fashion editorial lighting setup with multiple strobe heads and colored gels', duration: '1h 10min', tier: 'diafragma' as const, lessonCount: 28, rating: 5.0, price: 497, accessType: 'premium_purchase' as const },
  { id: 'pc-002', title: 'Sistema Completo: Negocio de Fotografía Comercial', instructor: 'Valentina Cruz', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_19b1925a8-1769680916668.png", thumbnailAlt: 'Behind the scenes of high-fashion editorial shoot with full crew and lighting team', duration: '2h 00min', tier: 'diafragma' as const, lessonCount: 32, rating: 4.9, price: 799, accessType: 'premium_purchase' as const },
  { id: 'pc-003', title: 'Flash de Alta Velocidad HSS', instructor: 'Carlos Mendoza', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_19c438e56-1772196420060.png", thumbnailAlt: 'High speed sync flash freezing motion of water droplet in professional studio setting', duration: '52:15', tier: 'diafragma' as const, lessonCount: 22, rating: 4.9, price: 397, accessType: 'premium_purchase' as const },
  { id: 'pc-004', title: 'Mascaras de Luminosidad Avanzadas', instructor: 'Alejandro Vega', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_13899cf87-1787075634525.png", thumbnailAlt: 'Advanced luminosity masking technique in Photoshop for selective color and tone control', duration: '55:00', tier: 'diafragma' as const, lessonCount: 18, rating: 4.9, price: 447, accessType: 'premium_purchase' as const },
];

const studioLighting = [
  { id: 'sl-001', title: 'Luz Natural vs Luz Artificial en Estudio', instructor: 'Carlos Mendoza', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_159d057e2-1787075637618.png", thumbnailAlt: 'Comparison of natural window light and artificial strobe light in photography studio', duration: '45:00', tier: 'apertura' as const, lessonCount: 18, rating: 4.8 },
...
const editing = [
  ...
  { id: 'ed-005', title: 'Eliminación de Fondos con IA', instructor: 'Sofía Reyes', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_1fa2cd15c-1787075634001.png", thumbnailAlt: 'AI-powered background removal tool in Photoshop removing complex hair strands', duration: '28:30', tier: 'apertura' as const, lessonCount: 8, rating: 4.6 },
];
...
const masterclasses = [
  ...
  { id: 'mc-002', title: 'Masterclass: Edición de Moda', instructor: 'Alejandro Vega', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_1a1118426-1767196174741.png", thumbnailAlt: 'Fashion photo editing masterclass live session with instructor screen sharing', duration: '1h 45min', tier: 'diafragma' as const, isLive: false, isLocked: true, lessonCount: 1 },
  { id: 'mc-003', title: 'Workshop: Portafolio y Marca Personal', instructor: 'Valentina Cruz', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_11ef698de-1768656193490.png", thumbnailAlt: 'Portfolio review workshop with instructor evaluating photography work on screen', duration: '1h 30min', tier: 'diafragma' as const, isLive: false, isLocked: true, lessonCount: 1 },
  { id: 'mc-004', title: 'Q&A: Equipamiento para Estudio', instructor: 'Carlos Mendoza', thumbnail: "https://img.rocket.new/generatedImages/rocket_gen_img_134d4276f-1773375271894.png", thumbnailAlt: 'Live Q&A session about studio equipment selection and budget recommendations', duration: '1h 00min', tier: 'diafragma' as const, isLive: true, isLocked: true, lessonCount: 1 },
];
...
export default function DashboardCarousels() {
  return (
    <div className="flex flex-col gap-10 pt-10">
      ...
      <CourseCarousel
        title="Incluido en tu Membresía"
        courses={includedInMembership}
        badgeLabel="Membresía"
        badgeColor="tier-badge-obturador"
      />
      <CourseCarousel
        title="Cursos Premium"
        courses={premiumCourses}
        badgeLabel="Compra Individual"
      ...
      <CourseCarousel
        title="Masterclasses y Talleres en Vivo"
